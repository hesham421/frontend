# /ORG/execute-frontend-test

Execute test scenarios for ORG — only for what's actually complete.
...
six phases are PENDING as of this generation, so the gate does not
pass yet.

If not all complete:
```
══════════════════════════════════════════════════════
⛔ TEST GATE FAILED — ORG
══════════════════════════════════════════════════════
...
Write to `reports/TEST-REPORT-ORG-frontend-[YYYY-MM-DD].md`. Any
