<!-- REFERENCE COPY — source of truth is backend/governance/modules/FILESVC/P3_5/test-plan.md — regenerate via that repo's agent3_splitter.py, do not hand-edit this copy -->
