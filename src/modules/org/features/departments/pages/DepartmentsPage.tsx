...
import { useDepartmentsFacade, useDepartment } from '../api/hooks';
import type { DepartmentTreeNodeResponse, CreateDepartmentRequest, UpdateDepartmentRequest } from '../api/departmentsApi';
