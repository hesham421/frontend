...
export class ErpErrorMapperService {
  ...
  private readonly errorMappings: Record<string, string> = {
    ...
    // PLAN-SEC-002 DataScope + Self-Service Auth (F3 — Section 4.2 Error Catalog)
    // MISSING_IN_DOCS: api-docs' auto-generated endpoint pages only list the generic
    // UNAUTHORIZED/INVALID_JSON responses, not these business codes — resolved from
    // backend source: erp-security SecurityErrorCodes.java (lines 76-88).
    'SEC_USER_PROFILE_BRANCH_INACTIVE': 'USER_PROFILES.BRANCH_REQUIRED_ACTIVE', // ERR-SEC-1034
    'SEC_ROLE_BRANCH_DATA_ACCESS_LEVEL_REQUIRED': 'ROLE_ACCESS.DATA_ACCESS_LEVEL_REQUIRED', // ERR-SEC-1035
    'SEC_ROLE_BRANCH_DUPLICATE_ASSIGNMENT': 'ROLE_ACCESS.BRANCH_ALREADY_ASSIGNED', // ERR-SEC-1036
    'SIGNUP_USERNAME_ALREADY_EXISTS': 'AUTH.USERNAME_ALREADY_EXISTS', // ERR-SEC-1040
    'SIGNUP_EMAIL_ALREADY_EXISTS': 'AUTH.EMAIL_ALREADY_EXISTS', // ERR-SEC-1041

    // File Service module (FILESVC) — Error Catalog, backend/erp-main/src/main/resources/i18n/messages.properties
    'FILE_CATEGORY_NOT_FOUND': 'ERRORS.FILE_CATEGORY_NOT_FOUND', // ERR-FILE-0009
    'FILE_DOCUMENT_NOT_FOUND': 'ERRORS.FILE_DOCUMENT_NOT_FOUND',
    'FILE_SIZE_EXCEEDED': 'ERRORS.FILE_SIZE_EXCEEDED', // ERR-FILE-0001
    'FILE_UPLOAD_READ_FAILED': 'ERRORS.FILE_UPLOAD_READ_FAILED',
    'FILE_NAME_REQUIRED': 'ERRORS.FILE_NAME_REQUIRED',
    'FILE_TOKEN_ISSUE_FAILED': 'ERRORS.FILE_TOKEN_ISSUE_FAILED',
    'FILE_TOKEN_EXPIRED': 'ERRORS.FILE_TOKEN_EXPIRED', // ERR-FILE-0002
    'FILE_TOKEN_INVALID': 'ERRORS.FILE_TOKEN_INVALID', // ERR-FILE-0003
    'FILE_TOKEN_ACTION_MISMATCH': 'ERRORS.FILE_TOKEN_INVALID', // ERR-FILE-0003 (same message, RULE-FILE-003)
    'FILE_TOKEN_ALREADY_USED': 'ERRORS.FILE_TOKEN_ALREADY_USED', // ERR-FILE-0004
    'FILE_ACCESS_TOKEN_ACTION_INVALID': 'ERRORS.FILE_ACCESS_TOKEN_ACTION_INVALID',
    'FILE_DELETE_NOT_AUTHORIZED': 'ERRORS.FILE_DELETE_NOT_AUTHORIZED', // ERR-FILE-0007
    'FILE_NO_LONGER_AVAILABLE': 'ERRORS.FILE_NO_LONGER_AVAILABLE', // ERR-FILE-0008

    // NOTIFICATION module — F3.md Frontend Validation Rule Specifications
    'NOTIF_TEMPLATE_BILINGUAL_REQUIRED': 'NOTIFICATIONS.ERR_BILINGUAL_REQUIRED', // ERR-NOTIF-0002 (RULE-NOTIF-006)
    'NOTIF_TEMPLATE_CODE_DUPLICATE': 'NOTIFICATIONS.ERR_CODE_DUPLICATE', // ERR-NOTIF-0003 (RULE-NOTIF-007)
