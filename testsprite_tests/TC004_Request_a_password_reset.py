...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Forgot Password?' button on the login form to open the password recovery flow.
        # Forgot Password? button
        elem = page.get_by_role('button', name='Forgot Password?', exact=True)
        await elem.click(timeout=10000)
        
        # -> Fill the 'Work Email Address' field with a valid email and click the 'Send Reset Link' button.
